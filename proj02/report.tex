...
(An implementation of soft-scoring for the Dictionary-based system is also done, with results we report later.)
...
\section{Kaggle csvs}
Many of our csvs submitted to kaggle are included in our submission. They are generally of the name\par
\texttt{dictionary\_test\_prediction\_winNUM-k-m-n-EXAMPLES-WORDNET.csv}.
